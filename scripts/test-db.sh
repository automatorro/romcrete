...
"${PSQL[@]}" -f supabase/tests/02_smoke.sql -f supabase/tests/05_crm.sql -f supabase/tests/06_domenii.sql -f supabase/tests/07_istoric.sql -f supabase/tests/08_arhiva_oferte.sql -f supabase/tests/09_rapoarte.sql -f supabase/tests/10_poze.sql -f supabase/tests/11_oferta_model.sql
