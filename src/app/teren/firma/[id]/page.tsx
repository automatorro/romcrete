...
export default async function FirmaPage(props: PageProps<"/teren/firma/[id]">) {
  ...
  return (
    <div>
      ...
      {/* Pe calculator: în stânga datele și acțiunile, în dreapta ce știm și istoricul. */}
      <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-6">
        ...
        <div>
          <h2 className="mt-5 mb-1 text-base font-semibold lg:mt-3">Ce știm despre firmă</h2>
